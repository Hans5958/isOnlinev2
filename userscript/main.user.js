// ==UserScript==
// @name         isOnline - The Second Port
// @namespace    scratch.mit.edu/user/Hans5958
// @version      2.1.5.2
// @description  Know who is online on Scratch! Ported for Tampermonkey/Greasemonkey use by Hans5958.
...
/*
We need to simulate localization. Let's try this.
*/
var i18n = JSON.parse("{\"loadingstatus\":{\"message\":\"Loading status...\"},\"validating\":{\"message\":\"Validating isOnline account\"},\"success\":{\"message\":\"Successfully validated your Scratch account.<br>isOnline is now working. <br>You can close this tab.\"},\"verifyerror\":{\"message\":\"An error occured. Please contact <a href=\'https:\/\/scratch.mit.edu\/users\/isOnlineV2#comments\'>@isOnlineV2<\/a> if you come from isOnline account validation.\"},\"validateprofilelink\":{\"message\":\"Validate this account <\/a> to use isOnline on it\"},\"clickforstatus\":{\"message\":\"Click to get status\"},\"onlineauto\":{\"message\":\"Automatic (Online)\"},\"offlineghost\":{\"message\":\"Offline (ghost)\"},\"online\":{\"message\":\"Online\"},\"probablyonline\":{\"message\":\"Probably Online\"},\"offline\":{\"message\":\"Offline\"},\"absent\":{\"message\":\"Away\"},\"unknown\":{\"message\":\"Unknown\"},\"notiouser\":{\"message\":\"Not iO user\"},\"error\":{\"message\":\"Error\"},\"didnotvalidate\":{\"message\":\"Whoops! Looks like you didn\'t validate your account on isOnline. isOnline won\'t work until you <a href=\'https:\/\/scratch.mit.edu\/isonline-extension\/register\' target=\'_blank\' >validate your account<\/a>. It takes around 20 seconds.\"},\"unvalidatedacc\":{\"message\":\"Whoops! isOnline isn\'t working on this Scratch account because it isn\'t validated. Want to use isOnline on this account too? <a href=\'https:\/\/scratch.mit.edu\/isonline-extension\/register\' target=\'_blank\' >Validate an additional user<\/a>.\"},\"keywaschanged\":{\"message\":\"Whoops! isOnline isn\'t working with this Scratch account because you used it on another computer. <a href=\'http:\/\/ison.ga\/sync\' target=\'_blank\'>Synchronize your computers<\/a> to avoid this error permanently or <a href=\'https:\/\/scratch.mit.edu\/isonline-extension\/register\' target=\'_blank\'>re-validate<\/a> to temporarily fix it.\"},\"isbot\":{\"message\":\"Whoops! It looks like you\'ve been marked as a bot by the isOnline server. isOnline isn\'t working. Please contact <a href=\'https:\/\/scratch.mit.edu\/users\/isOnlineV2\/#comments\' target=\'_blank\'>isOnlineV2<\/a> to unblock your account.\"},\"absenthelp\":{\"message\":\"The user has open inactive Scratch tabs.\"},\"unknownhelp\":{\"message\":\"isOnline did not detect activity in the last week. This user may not use isOnline anymore.\"},\"noiohelp\":{\"message\":\"This user has to install isOnline in order to show their status.\"},\"ownstatushelp\":{\"message\":\"Set your status manually, or leave it on automatic.\"},\"help\":{\"message\":\"Need help or have questions? Comment on\"},\"friendlist\":{\"message\":\"isOnline friends\"},\"friendsnote\":{\"message\":\"Note: You can disable notifications temporarily while keeping friends by setting your status to \\\"Do Not Disturb\\\" on your profile.\"},\"friendsettings\":{\"message\":\"Notification settings\"},\"notifyawayonline\":{\"message\":\"Notify if an Away friend goes Online\"},\"soundnotiftext\":{\"message\":\"Sound Notification\"},\"friendlistdescription\":{\"message\":\"Know the statuses of a maximum of 10 friends with just a click and receive instant desktop notifications when they get on!\"},\"nofriendshelp\":{\"message\":\"You can add people that follow you to your friend list by clicking \\\"+ friends\\\" on their profiles!\"},\"friendserror\":{\"message\":\"Error: <a href=\\\"https:\/\/scratch.mit.edu\/isonline-extension\/register\\\" target=\\\"_blank\\\">re-validate<\/a> to solve the problem.\"},\"loadingstatusesfrom\":{\"message\":\"Loading statuses from...\"},\"onetabopen\":{\"message\":\"<img src=\'sorryneedtabopen.png\' style=\'width:300px;display: absolute;margin: 0 auto;padding:0px;\'><\/img>\"},\"dndhelp1\":{\"message\":\"You won\'t receive any online friends notifications\"},\"dndhelp2\":{\"message\":\"and people will see you as offline on their friend list.\"},\"dnd\":{\"message\":\"Do Not Disturb\"},\"friends\":{\"message\":\"friends\"},\"maxreached\":{\"message\":\"Reached maximum amount of friends (10).\"},\"onlyfollowing\":{\"message\":\"You can only add users that are following you to your friend list.\"},\"dndotherhelp\":{\"message\":\"This user isn\'t receiving online friends notifications.\"},\"isnowonline\":{\"message\":\"is now online\"},\"isnowonlinebody\":{\"message\":\"Click to go to profile.\"},\"friendsnotcompatible\":{\"message\":\"isOnline friends only works in Chrome 17+ & Firefox 55+\"},\"notifyofflineonline\":{\"message\":\"Send a notification when a friend goes Online\"},\"adding\":{\"message\":\"Adding...\"},\"gotocomments\":{\"message\":\"Go to profile comments\"},\"removefromfriends\":{\"message\":\"Remove from friends\"},\"translationcredits\":{\"message\":\"\"},\"shiftenter\":{\"message\":\"Press Shift+Enter to post.\"}}");
function i18n_getMessage(x) {
	return i18n[x].message;
}
i18n_getMessage("loadingstatus");
...
/*
We don't have storage.sync or something like that. So, we need to replace it with something else.
...
/*
Don't isonlinev2 is dead? Let's just skip this whole thing.
        ...
        if (localuser.toUpperCase() == user.toUpperCase()) {iOlog("Detected user is their own profile");isOwn();} else {
            ...
            if(location.href.substring(location.href.indexOf('?')+1)==="comments"){
                ...
                var iOcomments = function(){if(document.getElementsByClassName("comment ").length>0){
                    ...
                    document.getElementById("main-post-form").getElementsByClassName("control-group")[0].getElementsByClassName("small-text")[0].innerHTML += " <b>"+i18n_getMessage("shiftenter")+"</b>";
            ...
            if(time()-localStorage.getItem("iOlastprofile")>3){status();}else{
                document.getElementById("iOstatus").innerHTML = "<a id='clickforstatus'>"+i18n_getMessage("clickforstatus")+"</a>";
...
/*
Seems we don't need the notification at all.
...
function status() {
    ...
    document.getElementById("iOstatus").innerHTML=i18n_getMessage("loadingstatus");
...
function isOwn(){
    iOcrown();
    opt = [{"name": i18n_getMessage("onlineauto"),   "value" : "online",  "color": "green"},
           {"name": i18n_getMessage("absent"),       "value" : "absent",  "color": "orange"},
           {"name": i18n_getMessage("dnd"),       "value" : "dnd",  "color": "gray"},
           {"name": i18n_getMessage("offlineghost"), "value" : "offline", "color": "red"}];
    ...
    document.getElementById("iOstatus").innerHTML += "<select id='ioselect' style='color: " + opt.find(k => localstatus() === k.value).color + ";'>" + opt.map(k => "<option class='io-option' style='color:" + k.color + ";' " + (k.value === localstatus() ? "selected" : "") +">" + k.name + "</option>") + '</select>'+getInfoHTML(i18n_getMessage("ownstatushelp"));
    document.getElementById("ioselect").addEventListener("change", changed);
    document.getElementById("ioselect").getElementsByTagName("option")[2].outerHTML += '<optgroup class="io-option-info" label="'+i18n_getMessage("dndhelp1")+'"></optgroup><optgroup class="io-option-info" label="'+i18n_getMessage("dndhelp2")+'"></optgroup>';

}

function isOnline() {
    iOlog("Detected that the user is online");
    document.getElementById("iOstatus").innerHTML = '<img src="https://scratchtools.pw/isonline/assets/online.svg" height="12" width="12"> <span id="iOstatustext" style="color:green">' + i18n_getMessage("online") + '</span>' ;}

function probablyOnline() {
    iOlog("Detected that the user is probably online");
    document.getElementById("iOstatus").innerHTML = '<img src="https://scratchtools.pw/isonline/assets/online.svg" height="12" width="12"> <span id="iOstatustext" style="color:green">' + i18n_getMessage("probablyonline") + '</span> ' + getInfoHTML(i18n_getMessage("probablyonlinehelp"));}

function isOffline() {
    iOlog("Detected that the user is offline");
    document.getElementById("iOstatus").innerHTML = '<img src="https://scratchtools.pw/isonline/assets/offline.svg" height="12" width="12"> <span id="iOstatustext" style="color:red">' + i18n_getMessage("offline") + '</span>' ;}

function isAbsent() {
    iOlog("Detected that the user is away");
    document.getElementById("iOstatus").innerHTML = '<img src="https://scratchtools.pw/isonline/assets/absent.svg" height="12" width="12"> <span id="iOstatustext" style="color:orange">' + i18n_getMessage("absent") + '</span> ' + getInfoHTML(i18n_getMessage("absenthelp"));}

function isUnknown() {
    iOlog("Detected that the user status is unknown");
    document.getElementById("iOstatus").innerHTML = i18n_getMessage("unknown") + " " + getInfoHTML(i18n_getMessage("unknownhelp"));}

function isDND() {
    iOlog("Detected that the user status is DND");
    document.getElementById("iOstatus").innerHTML = '<img src="https://scratchtools.pw/isonline/assets/dnd.svg" height="12" width="12"> <span id="iOstatustext" style="color:gray">' + "Do Not Disturb" + "</span> " + getInfoHTML(i18n_getMessage("dndotherhelp"));}

function noiO() {
    iOlog("Detected that the user didn't install isOnline");
    document.getElementById("iOstatus").innerHTML = i18n_getMessage("notiouser") + " " + getInfoHTML(i18n_getMessage("noiohelp"));}

function isError() { try{
    if (location.href.toLowerCase() == "https://scratch.mit.edu/users/discussbutton/") {return;}
    try { document.getElementById("iOstatus").innerHTML = '<span title="Error: ' + stop + '">' + i18n_getMessage("error") + '</span>';} catch(err){
        document.getElementsByClassName("location")[0].innerHTML += ' | <span title="Error: ' + stop + '">' + i18n_getMessage("error") + '</span>';}}catch(err){}}

function didntValidate() {
    if(location.href.startsWith("https://scratch.mit.edu/studios/4587248/comments/")){return;}
    try{ document.getElementById("alert-view").innerHTML="<div class='alert fade in alert-success' style='display: block;'><span class='close' onclick='document.getElementById(\"alert-view\").style.display=\"none\";'>×</span>" + i18n_getMessage("didnotvalidate") + "</div>";}catch(err){}}
...
function unvalidatedAcc() {
    ...
    try{document.getElementsByClassName("location")[0].innerHTML += ' | <small><a href="https://scratchtools.pw/isonline/register/" target="_blank">'+i18n_getMessage("validateprofilelink")+'</small>';}catch(err){}
    if (time()-localStorage.getItem("iObanner") < 86400) {return;}
    if(window.location.href.includes("users")){
        document.getElementById("alert-view").innerHTML="<div class='alert fade in alert-success' style='display: block;'><span class='close' onclick='document.getElementById(\"alert-view\").style.display=\"none\";localStorage.setItem(\"iObanner\"," + time() + ")'>×</span>" + i18n_getMessage("unvalidatedacc") + "</div>";}}
    ...
    if (stored == "n") {
        chrome.storage.sync.get("iOaccounts", function (data) {
            ...
            if(oldkey==key){
                ...
                try{console.error("isOnline was stopped: Key was changed");document.getElementById("alert-view").innerHTML="<div class='alert fade in alert-success' style='display: block;'><span class='close' onclick='document.getElementById(\"alert-view\").style.display=\"none\";'>×</span>" + i18n_getMessage("keywaschanged") + "</div>";}catch(err){}
...
function isBot() { try{
    ...
    document.getElementById("alert-view").innerHTML="<div class='alert fade in alert-success' style='display: block;'><span class='close' onclick='document.getElementById(\"alert-view\").style.display=\"none\";'>×</span>" + i18n_getMessage("isbot") + "</div>";}catch(err){}}
...
function validateAccount(){
    document.documentElement.innerHTML = "<!DOCTYPE html><html><head><style>body{background: #f0f0f0;margin: 0;}#vcenter{position: absolute;top: 50%;width: 100%;margin-top: -100px;}h1{text-align: center;font-family: trebuchet ms, courier new, sans-serif;font-size: 2em;}#loader,#loader:before,#loader:after{border-radius: 50%;width: 2.5em;height: 2.5em;-webkit-animation-fill-mode: both;animation-fill-mode: both;-webkit-animation: load7 1.8s infinite ease-in-out;animation: load7 1.8s infinite ease-in-out;}#loader{color: #098e8b;font-size: 10px;margin: 80px auto;position: relative;text-indent: -9999em;-webkit-transform: translateZ(0);-ms-transform: translateZ(0);transform: translateZ(0);-webkit-animation-delay: -0.16s;animation-delay: -0.16s;}#loader:before,#loader:after{content: '';position: absolute;top: 0;}#loader:before{left: -3.5em;-webkit-animation-delay: -0.32s;animation-delay: -0.32s;}#loader:after{left: 3.5em;}@-webkit-keyframes load7{0%,80%,100%{box-shadow: 0 2.5em 0 -1.3em;}40%{box-shadow: 0 2.5em 0 0;}}@keyframes load7{0%,80%,100%{box-shadow: 0 2.5em 0 -1.3em;}40%{box-shadow: 0 2.5em 0 0;}}</style></head><body><div id='vcenter'><h1 id='header'>" + i18n_getMessage("validating") + "...</h1><div id='loader'></div></div></body></html>";
    ...
    test.onreadystatechange = function() {
        if (test.readyState === 4 && test.status === 200 && test.responseText == '{"valid":true}') {
            if ((indx = registeredUsers.findIndex(k => k.name === localuser)) === -1) {
				localStorage.setItem("iOaccounts", JSON.stringify((registeredUsers === null ? [] : registeredUsers).concat({"name": localuser,"key": location.hash.substring(1)})));
                /*
				...
				*/
				...
				localStorage.setItem("iOaccounts", JSON.stringify(registeredUsers.slice(0, indx).concat({"name": localuser,"key": location.hash.substring(1)}).concat(registeredUsers.slice(indx + 1))));
				/*
                chrome.storage.sync.set({"iOaccounts" : JSON.stringify(registeredUsers.slice(0, indx).concat({
                    "name": localuser,
                    "key": location.hash.substring(1)
            ...
            document.getElementById("header").innerHTML = "<center><h3 style='color:green'>" + i18n_getMessage("success") + "</h3></center>";
        } else {
            document.getElementById("loader").style.display = "none";
            document.getElementById("header").innerHTML = "<center><h3 style='color:red'>"+i18n_getMessage("verifyerror")+"</h3></center>";
        }
...
function addFriendButton(){
    ...
    document.getElementsByClassName("header-text")[0].getElementsByTagName("h2")[0].outerHTML += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="addfrienddiv" style="display:inline;vertical-align:top;"><a id="addfriend"><small>+ '+i18n_getMessage("friends")+'</small></a></span>';
    document.getElementById("addfriend").onclick = function(){
        document.getElementById("addfrienddiv").innerHTML="<small>"+i18n_getMessage("adding")+"</small>";
        chrome.runtime.sendMessage({addfriend: [user,localuser]}, function (response){
            ...
            if(response.result=="maxreached") {document.getElementById("addfrienddiv").innerHTML="<small>"+i18n_getMessage("maxreached");+"</small"}
            if(response.result=="onlyfollowing") {document.getElementById("addfrienddiv").innerHTML="<small>"+i18n_getMessage("onlyfollowing")+"</small>";}
        });
    };
}
...
function removeFriendButton() {
    document.getElementsByClassName("header-text")[0].getElementsByTagName("h2")[0].style.display="inline";
    document.getElementsByClassName("header-text")[0].getElementsByTagName("h2")[0].outerHTML += '<span id="removefrienddiv" style="display:inline;vertical-align:top;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="removefriend"><small>x '+i18n_getMessage("friends")+'</small></a></span>';
